...
- For a list of entrance names, check the entrances/exits of `SM64PlandoConnections` from [`Options.py` in the sm64ex world folder](../Options.py) or generate a game with the Entrance Randomizer option enabled and check the spoiler log.
