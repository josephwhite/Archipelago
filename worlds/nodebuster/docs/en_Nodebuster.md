...
Due to the game being unsupported currently there is no options page, and you must change the settings directly in the yaml file.

## What does randomization do to this game?

Randomization swaps around what upgrade nodes will give when bought.

Options can be utilized to also randomize the following:
* Minestone Rewards
* Cores ("Boss Drops")
* Crypto Mine levels
...
Deploy the godvirus. Options can be utilized to include more conditions like collecting all Infinities.
