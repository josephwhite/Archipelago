...
progressive_items_exclude_list: list[str] = [
    # Progressive Damage
    "Damage1", "DamagePerEnemy1", "BossDamage1", "Damage2", "Damage3", "Undamaged1", "Execute1", "Damage4",
    "BossDamage2", "Damage5", "Undamaged2", "Execute2", "RampingDamage1", "MaxHealthToDamage1",
    # Progressive Critical Damage
    "CritDamage1", "CritDamage2",
    # Progressive Health
    "Health1", "Health2", "Health3", "Health4", "Health5", "Health6", "Health7",
    # Progressive Regen
    "HealthRegen1", "Salvaging1", "Lifesteal1", "HealthRegen2", "Salvaging2", "DropHeal1", "MaxHealthHeal1",
    "Lifesteal2", "Lifesteal3", "StealMaxHealth1", "MaxHealthHeal2", "StealMaxHealth2", "StealMaxHealth3",
...
def progressive_item_to_vanilla(upgrade: str, count: int) -> list[str]:
    vanilla_items = []
